...
## Running the notebooks in qBriad, CoCalc, or Google Colab
Simply click on the icons at the bottom of each notebook.  You will have to uncomment the `pip install cudaq` cells to run your notebook on Google Colab.
